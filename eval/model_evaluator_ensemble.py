...
def main(args):
    from models.dense_head_rir_unet import UNet  # Moving import line here to reduce confusion.
    ...
    if Path(args.data_root).name.endswith('val'):
        ...
        print('preprocessimg')
    elif Path(args.data_root).name.endswith('test_v2') or Path(args.data_root).name.endswith('challenge'):
...
if __name__ == '__main__':
    ...
    defaults = dict(
        ...
        data_root='/media/user/Data/compFastMRI/multicoil_challenge',

        # checkpoint_path='checkpoints/I2R/Trial 30  2019-09-15 16-58-16/ckpt_015.tar',
        checkpoint_path_4='checkpoints/I2R/Trial-01/2019-09-19-cp02-acc4-all.tar',
        checkpoint_path_8='checkpoints/I2R/Trial-01/2019-09-19-cp01-acc8-all.tar',

        ensemble=True,

        out_dir='./recons/JH_full_challenge',  # Change this every time! Attempted overrides will throw errors by design.
