...
from models.multi_edsr_unet import UNet
...
def train_img_to_rss(args):
    ...
    model = UNet(in_chans=in_chans, out_chans=1, chans=args.chans, num_pool_layers=args.num_pool_layers,
                 num_res_layers=args.num_res_layers, num_depth_blocks=args.num_depth_blocks, res_scale=args.res_scale,
...
if __name__ == '__main__':
    ...
    settings = dict(
        ...
        num_depth_blocks=32,
        num_pool_layers=2,
        num_res_layers=[8, 8],  # This can be an int or list/tuple
        thick_base=True,
