...
class Unet(nn.Module):
    def __init__(self, in_chans, out_chans, chans, num_pool_layers):
        ...
        self.conv = ConvBlock(in_chans=in_chans, out_chans=chans)
...
class UnetKS(nn.Module):
    def __init__(self, in_chans, out_chans, ext_chans, chans, num_pool_layers,
        ...
        #     in_chans=in_chans, out_chans=in_chans, ext_chans=ext_chans,
        #     min_ext_size=min_ext_size, max_ext_size=max_ext_size, use_bias=use_ext_bias)

        self.extractor = Unet(in_chans=in_chans, out_chans=out_chans, chans=16, num_pool_layers=2)
    ...
    def forward(self, tensor):
        ...
        return self.conv_last(output), extracted
