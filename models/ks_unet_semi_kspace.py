...
class ConvBlock(nn.Module):
    def __init__(self, in_chans, out_chans):
        ...
        self.layers = nn.Sequential(
            nn.Conv2d(in_chans, out_chans, kernel_size=(1, 5), padding=(0, 2), bias=True),
            nn.ReLU(),
            nn.Conv2d(out_chans, out_chans, kernel_size=(1, 5), padding=(0, 2), bias=False),
...
class UnetKS(nn.Module):
    ...
    def forward(self, tensor):
        ...
        return self.conv_last(output) + tensor
