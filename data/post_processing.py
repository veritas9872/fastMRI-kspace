from data.data_transforms import ifft2, complex_abs, chw_to_k_slice
...
class TrainOutputSliceTransform:
    ...
    """
    def __init__(self, k_slice_fn=None, img_slice_fn=None, amplification_factor=1E4):  # Make as I go.
        """
